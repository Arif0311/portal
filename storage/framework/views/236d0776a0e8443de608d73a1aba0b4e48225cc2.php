  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li  class="active"><a href=" <?php echo e(route ('temperature')); ?>"><i class="glyphicon glyphicon-list-alt"></i><span>Data Temperatur</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Temperature</li>
      </ol>
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <div class="card-tools">
                      <a href="<?php echo e(route('createTemperature')); ?>" class="btn btn-success" style="background-color:#04d984" method="GET">Input Temperature</a>
                    </div>
                    <br/>
                    <tr>
                      <th>No</th>
                  ...
                  <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td>
                        <a type="button" class="btn btn-warning" href="<?php echo e(route('editTemperature' , $data)); ?>"><i class="fa fa-edit"></i></a>
                        <form role="form" method="post" action="">
                        <?php echo e(csrf_field()); ?>

                            <div class="form-group">
                                <a type="button" class="btn btn-danger delete-confirm" href="<?php echo e(route('deleteTemperature' , $data)); ?>"><i class="fa fa-close"></i></a>
                            </div>
                        </form>
                      </td>
                    </tr>
...
</html><?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia 2/resources/views/TemperatureTracking.blade.php ENDPATH**/ ?>