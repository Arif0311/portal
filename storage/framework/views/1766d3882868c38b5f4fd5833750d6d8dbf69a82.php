      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <!-- form start -->
              <form role="form" action="/visitorCheckout/store" method="post" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime" class="form-control" data-date-format="dd-mm-yyyy H:i:s" name="date_in_visitor" autocomplete="on">
                    </div> -->
                    <div class="form-group">
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia 2/resources/views/CreateVisitorCheckout.blade.php ENDPATH**/ ?>