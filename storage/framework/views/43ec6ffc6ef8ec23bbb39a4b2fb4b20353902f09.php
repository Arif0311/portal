  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo e(route('login')); ?>"><i class="glyphicon glyphicon-arrow-left"></i> <span>Back to Login</span></a></li>
      </ul>
    </section>
  </aside>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <form role="form" action="<?php echo e(route('storeVisitor')); ?>" method="post" onchange="validateImage()" enctype="multipart/form-data">
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia 2/resources/views/CreateVisitor.blade.php ENDPATH**/ ?>