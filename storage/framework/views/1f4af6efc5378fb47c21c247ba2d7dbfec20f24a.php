    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="/temperature/store" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="meeting-time" class="form-control" max="2100-01-01T00:00" min="2020-01-01T00:00" name="inputDate" size="60" style="width:100%" type="datetime-local" required>
                    </div>
                    <!-- <div class="form-group">
                        <label>Input Date and Time</label>
                        <input type="time" class="form-control" name="created_at" placeholder="created_at">
                    </div> -->
                    <!-- /.box-body -->
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia/resources/views/CreateTemperature.blade.php ENDPATH**/ ?>