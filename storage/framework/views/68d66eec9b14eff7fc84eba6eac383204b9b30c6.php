  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li  class="active"><a href=" <?php echo e(route ('temperature')); ?>"><i class="fa fa-table"></i><span>Temperatur Tracking</span></a></li>
        <!-- 
                ...
                <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form role="form" method="post" action="<?php echo e(route('deleteTemperature' , $data)); ?>">
...
</html><?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia/resources/views/Temperature/TemperatureTracking.blade.php ENDPATH**/ ?>