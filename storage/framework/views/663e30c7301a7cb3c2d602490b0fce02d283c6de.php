      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <!-- form start -->
              <form role="form" action="<?php echo e(route('updateVisitor', $datas)); ?>" method="post">
              ...
              <?php echo e(csrf_field()); ?>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="visitor_name" placeholder="Visitor Name" value="<?php echo e($datas->visitor_name); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputVisitorEmail">Visitor Email </label>
                        <input type="email" class="form-control" name="visitor_email" placeholder="Visitor Email" value="<?php echo e($datas->visitor_email); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputVisitorInformation">Visitor Address or Company</label>
                        <input type="text" class="form-control" name="visitor_information" placeholder="Visitor Information" value="<?php echo e($datas->visitor_information); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputMobileNumber">Visitor Mobile Number </label>
                        <input type="number" class="form-control" name="visitor_mobile_number" placeholder="Mobile Number" value="<?php echo e($datas->visitor_mobile_number); ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="person_visiting" placeholder="Person Visiting" value="<?php echo e($datas->person_visiting); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputTemperature">Body Temperature</label>
                        <input type="number" maxlength="3" step="0.1" max="39.0" min="34.0" value="36.0" class="form-control" name="body_temperature" placeholder="Temperature" value="<?php echo e($datas->time_out); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputVisitorAccessCard">Visitor Access Card </label>
                        <input type="number" class="form-control" name="visitor_access_card" placeholder="visitor Access Card" value="<?php echo e($datas->visitor_access_card); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Input Date/Time</label>
                        <input id="meeting-time" class="form-control" max="2100-01-01T00:00" min="2020-01-01T00:00" name="date_in_visitor" size="60" style="width:100%" type="datetime-local" value="<?php echo e($datas->date_in_visitor); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Time Out</label>
                        <input id="meeting-time" class="form-control" max="2100-01-01T00:00" min="2020-01-01T00:00" name="time_out" size="60" style="width:100%" type="datetime-local" value="<?php echo e($datas->time_out); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Description:</label>
                        <textarea type="text" class="form-control" name="description" placeholder="Enter Description" value="<?php echo e($datas->description); ?>" required></textarea>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="photo">Photo</label>
                        <input type="file" class="form-control" id="photo" name="photo" value="<?php echo e($datas->photo); ?>" required>
                    </div>
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia/resources/views/EditVisitor.blade.php ENDPATH**/ ?>