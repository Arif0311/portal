      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <!-- form start -->
              <form role="form" action="<?php echo e(route('updateEmployee' , $datas)); ?>" method="post"> 
              ...
              <?php echo e(csrf_field()); ?>
                ...
                <div class="box-body">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="fullname" placeholder="Enter fullnama" value="<?php echo e($datas->fullname); ?>">
                  </div>
                  <div class="form-group">
                      <label>Role</label>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="position" placeholder="position" value="<?php echo e($datas->position); ?>">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputDepartment">Department</label>
                      <input type="text" class="form-control" name="department" placeholder="department" value="<?php echo e($datas->department); ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="email" placeholder="email" value="<?php echo e($datas->email); ?>">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputMobileNumber">Mobile Number</label>
                      <input type="text" class="form-control" name="mobile number" placeholder="mobile number" value="<?php echo e($datas->mobile_number); ?>">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputAddres">Addres</label>
                      <input type="text" class="form-control" name="addres" placeholder="addres" value="<?php echo e($datas->addres); ?>">
                  </div>
                  <div class="form-group">
                      <label for="password">Password</label>
                      <input id="password" type="password" class="form-control" name="password" placeholder="password" value="<?php echo e($datas->password); ?>">
                  </div>
                </div>
                <!-- /.box-body -->
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia/resources/views/EditDataEmployee.blade.php ENDPATH**/ ?>