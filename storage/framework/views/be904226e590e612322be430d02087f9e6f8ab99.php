  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#"><i class="fa fa-edit"></i> Create Employee</a></li>
      </ol>
    </section>
              ...
              <?php echo e(csrf_field()); ?>
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="name" class="form-control" name="fullname" placeholder="Enter fullname" required>
                  </div>
                  <div class="form-group">
                      <label>Role</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="addres" placeholder="addres" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <select id="is_admin" type="number" maxlength="2" max="1" min="0" class="form-control" name="is_admin" required>
                        <option></option>
                        <option>0</option>
                        <option>1</option>
                    </select>
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia 2/resources/views/createEmployee.blade.php ENDPATH**/ ?>