    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="<?php echo e(route('storeTemperature')); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="enabled" placeholder="enabled">
                    </div>
                    <div class="form-group">
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia/resources/views/Temperature/CreateTemperature.blade.php ENDPATH**/ ?>