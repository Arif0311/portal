      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
              ...
              <!-- form start -->
              <form role="form" action="<?php echo e(route('updateVisitor', $datas)); ?>" method="post" enctype="multipart/form-data">
              ...
              <?php echo e(csrf_field()); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" maxlength="3" step="0.1" max="39.0" min="34.0" value="36.0" class="form-control" name="body_temperature" placeholder="Temperature" value="<?php echo e($datas->body_temperature); ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="description" placeholder="description" value="<?php echo e($datas->description); ?>">
                    </div>
                    <!-- <div class="form-group">
                        <label class="form-label" for="photo">Photo</label>
                        <input type="hidden"name="oldPhoto" value="<?php echo e($datas->photo); ?>">
                        <br>
                        <?php if($datas->photo): ?>
                            <img src="<?php echo e(asset('storage/' . $datas->photo)); ?>" class="img-preview img-fluid mb-0 col-sm-2 responsive">
                        <?php else: ?>
                            <img class="img-preview img-fluid mb-0 col-sm-2 responsive">
                        <?php endif; ?>
                        <input type="file" accept="image/*" class="form-control" id="photo" name="photo" src="<?php echo e(asset('storage/' . $datas->photo)); ?>" onchange="previewImage()" required>
                    </div> -->
...
<?php /**PATH /Users/admin_fintopia/Documents/Indoportal-Fintopia 2/resources/views/EditVisitor.blade.php ENDPATH**/ ?>