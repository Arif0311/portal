  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li  class="active"><a href=" {{ route ('temperature') }}"><i class="glyphicon glyphicon-list-alt"></i><span>Data Temperatur</span></a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <div class="card-tools">
                      <a href="{{ route('createTemperature') }}" class="btn btn-success" style="background-color:#04d984" method="GET">Input Temperature</a>
                    </div>
                    <br/>
                    <tr>
                      <th>No</th>
                  ...
                  @foreach($datas as $key=>$data)
                    <tr>
                      ...
                      <td>
                        <a type="button" class="btn btn-warning" href="{{ route('editTemperature' , $data) }}"><i class="fa fa-edit"></i></a>
                        <form role="form" method="post" action="">
                        {{ csrf_field() }}
                            <div class="form-group">
                                <a type="button" class="btn btn-danger delete-confirm" href="{{ route('deleteTemperature' , $data) }}"><i class="fa fa-close"></i></a>
                            </div>
                        </form>
                      </td>
                    </tr>
