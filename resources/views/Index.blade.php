  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{ route('index') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Welcome, In Fintopia {{ Auth::user()->fullname }}</h3>
              </div>
              <!-- Main content -->
              @can('admin')
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                      <div class="inner">
                        <h3>{{$totalTemperature ?? ''}}<sup style="font-size: 20px"></sup></h3>
